...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Abort (MPI_Comm comm=%s, int errorcode=%d)", comm_to_string(comm), errorcode);
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Add_error_class (int *errorclass=%p)", errorclass);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Add_error_code (int errorclass=%d, int *errorcode=%p)", errorclass, errorcode);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Add_error_string (int errorcode=%d, char *string=%p)", errorcode, string);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Address (void *location=%p, MPI_Aint *address=%p)", location, address);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Allgather (void *sendbuf=%p, int sendcount=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int recvcount=%d, MPI_Datatype recvtype=%s, MPI_Comm comm=%s)", sendbuf, sendcount, type_to_string(sendtype), recvbuf, recvcount, type_to_string(recvtype), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Allgatherv (void *sendbuf=%p, int sendcount=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int *recvcounts=%p, int *displs=%p, MPI_Datatype recvtype=%s, MPI_Comm comm=%s)", sendbuf, sendcount, type_to_string(sendtype), recvbuf, recvcounts, displs, type_to_string(recvtype), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Alloc_mem (MPI_Aint size=%p, MPI_Info info=%s, void *baseptr=%p)", (void *) size, info_to_string(info), baseptr);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Allreduce (void *sendbuf=%p, void *recvbuf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Op op=%s, MPI_Comm comm=%s)", sendbuf, recvbuf, count, type_to_string(datatype), op_to_string(op), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Alltoall (void *sendbuf=%p, int sendcount=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int recvcount=%d, MPI_Datatype recvtype=%s, MPI_Comm comm=%s)", sendbuf, sendcount, type_to_string(sendtype), recvbuf, recvcount, type_to_string(recvtype), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Alltoallv (void *sendbuf=%p, int *sendcnts=%p, int *sdispls=%p, MPI_Datatype sendtype=%s, void *recvbuf=%p, int *recvcnts=%p, int *rdispls=%p, MPI_Datatype recvtype=%s, MPI_Comm comm=%s)", sendbuf, sendcnts, sdispls, type_to_string(sendtype), recvbuf, recvcnts, rdispls, type_to_string(recvtype), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Alltoallw (void *sendbuf=%p, int *sendcnts=%p, int *sdispls=%p, MPI_Datatype *sendtypes=%p, void *recvbuf=%p, int *recvcnts=%p, int *rdispls=%p, MPI_Datatype *recvtypes=%p, MPI_Comm comm=%s)", sendbuf, sendcnts, sdispls, sendtypes, recvbuf, recvcnts, rdispls, recvtypes, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Attr_delete (MPI_Comm comm=%s, int keyval=%d)", comm_to_string(comm), keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Attr_get (MPI_Comm comm=%s, int keyval=%d, void *attr_value=%p, int *flag=%p)", comm_to_string(comm), keyval, attr_value, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Attr_put (MPI_Comm comm=%s, int keyval=%d, void *attr_value=%p)", comm_to_string(comm), keyval, attr_value);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Barrier (MPI_Comm comm=%s)", comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Bcast (void *buffer=%p, int count=%d, MPI_Datatype datatype=%s, int root=%d, MPI_Comm comm=%s)", buffer, count, type_to_string(datatype), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Bsend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Bsend_init (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Buffer_attach (void *buffer=%p, int size=%d)", buffer, size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Buffer_detach (void *buffer=%p, int *size=%p)", buffer, size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cancel (MPI_Request *request=%p)", request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_coords (MPI_Comm comm=%s, int rank=%d, int maxdims=%d, int *coords=%p)", comm_to_string(comm), rank, maxdims, coords);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_create (MPI_Comm comm_old=%s, int ndims=%d, int *dims=%p, int *periods=%p, int reorder=%d, MPI_Comm *comm_cart=%p)", comm_to_string(comm_old), ndims, dims, periods, reorder, comm_cart);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cartdim_get (MPI_Comm comm=%s, int *ndims=%p)", comm_to_string(comm), ndims);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_get (MPI_Comm comm=%s, int maxdims=%d, int *dims=%p, int *periods=%p, int *coords=%p)", comm_to_string(comm), maxdims, dims, periods, coords);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_map (MPI_Comm comm_old=%s, int ndims=%d, int *dims=%p, int *periods=%p, int *newrank=%p)", comm_to_string(comm_old), ndims, dims, periods, newrank);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_rank (MPI_Comm comm=%s, int *coords=%p, int *rank=%p)", comm_to_string(comm), coords, rank);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_shift (MPI_Comm comm=%s, int direction=%d, int displ=%d, int *source=%p, int *dest=%p)", comm_to_string(comm), direction, displ, source, dest);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Cart_sub (MPI_Comm comm=%s, int *remain_dims=%p, MPI_Comm *comm_new=%p)", comm_to_string(comm), remain_dims, comm_new);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Close_port (char *port_name=%p)", port_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_accept (char *port_name=%p, MPI_Info info=%s, int root=%d, MPI_Comm comm=%s, MPI_Comm *newcomm=%p)", port_name, info_to_string(info), root, comm_to_string(comm), newcomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_call_errhandler (MPI_Comm comm=%s, int errorcode=%d)", comm_to_string(comm), errorcode);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_compare (MPI_Comm comm1=%s, MPI_Comm comm2=%s, int *result=%p)", comm_to_string(comm1), comm_to_string(comm2), result);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_connect (char *port_name=%p, MPI_Info info=%s, int root=%d, MPI_Comm comm=%s, MPI_Comm *newcomm=%p)", port_name, info_to_string(info), root, comm_to_string(comm), newcomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_create_errhandler (MPI_Comm_errhandler_fn *function=%p, MPI_Errhandler *errhandler=%p)", function, errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_create (MPI_Comm comm=%s, MPI_Group group=%s, MPI_Comm *newcomm=%p)", comm_to_string(comm), group_to_string(group), newcomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_create_keyval (MPI_Comm_copy_attr_function *comm_copy_attr_fn=%p, MPI_Comm_delete_attr_function *comm_delete_attr_fn=%p, int *comm_keyval=%p, void *extra_state=%p)", comm_copy_attr_fn, comm_delete_attr_fn, comm_keyval, extra_state);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_delete_attr (MPI_Comm comm=%s, int comm_keyval=%d)", comm_to_string(comm), comm_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_disconnect (MPI_Comm *comm=%p)", comm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_dup (MPI_Comm comm=%s, MPI_Comm *newcomm=%p)", comm_to_string(comm), newcomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_free (MPI_Comm *comm=%p)", comm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_free_keyval (int *comm_keyval=%p)", comm_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_get_attr (MPI_Comm comm=%s, int comm_keyval=%d, void *attribute_val=%p, int *flag=%p)", comm_to_string(comm), comm_keyval, attribute_val, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_get_errhandler (MPI_Comm comm=%s, MPI_Errhandler *errhandler=%p)", comm_to_string(comm), errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_get_name (MPI_Comm comm=%s, char *comm_name=%p, int *resultlen=%p)", comm_to_string(comm), comm_name, resultlen);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_get_parent (MPI_Comm *parent=%p)", parent);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_group (MPI_Comm comm=%s, MPI_Group *group=%p)", comm_to_string(comm), group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_join (int fd=%d, MPI_Comm *intercomm=%p)", fd, intercomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_rank (MPI_Comm comm=%s, int *rank=%p)", comm_to_string(comm), rank);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_remote_group (MPI_Comm comm=%s, MPI_Group *group=%p)", comm_to_string(comm), group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_remote_size (MPI_Comm comm=%s, int *size=%p)", comm_to_string(comm), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_set_attr (MPI_Comm comm=%s, int comm_keyval=%d, void *attribute_val=%p)", comm_to_string(comm), comm_keyval, attribute_val);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_set_errhandler (MPI_Comm comm=%s, MPI_Errhandler errhandler=%p)", comm_to_string(comm), (void *) errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_set_name (MPI_Comm comm=%s, char *comm_name=%p)", comm_to_string(comm), comm_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_size (MPI_Comm comm=%s, int *size=%p)", comm_to_string(comm), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_spawn (char *command=%p, char *argv[]=%p, int maxprocs=%d, MPI_Info info=%s, int root=%d, MPI_Comm comm=%s, MPI_Comm *intercomm=%p, int array_of_errcodes[]=%p)", command, argv, maxprocs, info_to_string(info), root, comm_to_string(comm), intercomm, array_of_errcodes);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_split (MPI_Comm comm=%s, int color=%d, int key=%d, MPI_Comm *newcomm=%p)", comm_to_string(comm), color, key, newcomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_test_inter (MPI_Comm comm=%s, int *flag=%p)", comm_to_string(comm), flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Dims_create (int nnodes=%d, int ndims=%d, int *dims=%p)", nnodes, ndims, dims);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_create (MPI_Handler_function *function=%p, MPI_Errhandler *errhandler=%p)", function, errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_free (MPI_Errhandler *errhandler=%p)", errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_get (MPI_Comm comm=%s, MPI_Errhandler *errhandler=%p)", comm_to_string(comm), errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_set (MPI_Comm comm=%s, MPI_Errhandler errhandler=%p)", comm_to_string(comm), (void *) errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Error_class (int errorcode=%d, int *errorclass=%p)", errorcode, errorclass);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Error_string (int errorcode=%d, char *string=%p, int *resultlen=%p)", errorcode, string, resultlen);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Exscan (void *sendbuf=%p, void *recvbuf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Op op=%s, MPI_Comm comm=%s)", sendbuf, recvbuf, count, type_to_string(datatype), op_to_string(op), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_call_errhandler (MPI_File fh=%s, int errorcode=%d)", file_to_string(fh), errorcode);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_close (MPI_File *mpi_fh=%p)", mpi_fh);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_create_errhandler (MPI_File_errhandler_fn *function=%p, MPI_Errhandler *errhandler=%p)", function, errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_delete (char *filename=%p, MPI_Info info=%s)", filename, info_to_string(info));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_amode (MPI_File mpi_fh=%s, int *amode=%p)", file_to_string(mpi_fh), amode);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_atomicity (MPI_File mpi_fh=%s, int *flag=%p)", file_to_string(mpi_fh), flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_byte_offset (MPI_File mpi_fh=%s, MPI_Offset offset=%p, MPI_Offset *disp=%p)", file_to_string(mpi_fh), (void *) offset, disp);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_errhandler (MPI_File file=%s, MPI_Errhandler *errhandler=%p)", file_to_string(file), errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_group (MPI_File mpi_fh=%s, MPI_Group *group=%p)", file_to_string(mpi_fh), group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_info (MPI_File mpi_fh=%s, MPI_Info *info_used=%p)", file_to_string(mpi_fh), info_used);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_position (MPI_File mpi_fh=%s, MPI_Offset *offset=%p)", file_to_string(mpi_fh), offset);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_position_shared (MPI_File mpi_fh=%s, MPI_Offset *offset=%p)", file_to_string(mpi_fh), offset);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_size (MPI_File mpi_fh=%s, MPI_Offset *size=%p)", file_to_string(mpi_fh), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_type_extent (MPI_File mpi_fh=%s, MPI_Datatype datatype=%s, MPI_Aint *extent=%p)", file_to_string(mpi_fh), type_to_string(datatype), extent);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_get_view (MPI_File mpi_fh=%s, MPI_Offset *disp=%p, MPI_Datatype *etype=%p, MPI_Datatype *filetype=%p, char *datarep=%p)", file_to_string(mpi_fh), disp, etype, filetype, datarep);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iread_at (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPIO_Request *request=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iread (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Request *request=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iread_shared (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Request *request=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iwrite_at (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPIO_Request *request=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iwrite (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Request *request=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_iwrite_shared (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPIO_Request *request=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_open (MPI_Comm comm=%s, char *filename=%p, int amode=%d, MPI_Info info=%s, MPI_File *fh=%p)", comm_to_string(comm), filename, amode, info_to_string(info), fh);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_preallocate (MPI_File mpi_fh=%s, MPI_Offset size=%p)", file_to_string(mpi_fh), (void *) size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_all_begin (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_all_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_all (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_at_all_begin (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_at_all_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_at_all (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_at (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_ordered_begin (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_ordered_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_ordered (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_read_shared (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_seek (MPI_File mpi_fh=%s, MPI_Offset offset=%p, int whence=%d)", file_to_string(mpi_fh), (void *) offset, whence);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_seek_shared (MPI_File mpi_fh=%s, MPI_Offset offset=%p, int whence=%d)", file_to_string(mpi_fh), (void *) offset, whence);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_set_atomicity (MPI_File mpi_fh=%s, int flag=%d)", file_to_string(mpi_fh), flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_set_errhandler (MPI_File file=%s, MPI_Errhandler errhandler=%p)", file_to_string(file), (void *) errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_set_info (MPI_File mpi_fh=%s, MPI_Info info=%s)", file_to_string(mpi_fh), info_to_string(info));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_set_size (MPI_File mpi_fh=%s, MPI_Offset size=%p)", file_to_string(mpi_fh), (void *) size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_set_view (MPI_File mpi_fh=%s, MPI_Offset disp=%p, MPI_Datatype etype=%s, MPI_Datatype filetype=%s, char *datarep=%p, MPI_Info info=%s)", file_to_string(mpi_fh), (void *) disp, type_to_string(etype), type_to_string(filetype), datarep, info_to_string(info));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_sync (MPI_File mpi_fh=%s)", file_to_string(mpi_fh));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_all_begin (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_all_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_all (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_at_all_begin (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_at_all_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_at_all (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_at (MPI_File mpi_fh=%s, MPI_Offset offset=%p, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), (void *) offset, buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_ordered_begin (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s)", file_to_string(mpi_fh), buf, count, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_ordered_end (MPI_File mpi_fh=%s, void *buf=%p, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_ordered (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_write_shared (MPI_File mpi_fh=%s, void *buf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Status *status=%p)", file_to_string(mpi_fh), buf, count, type_to_string(datatype), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Finalized (int *flag=%p)", flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Finalize ()");
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Free_mem (void *base=%p)", base);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Gather (void *sendbuf=%p, int sendcnt=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int recvcnt=%d, MPI_Datatype recvtype=%s, int root=%d, MPI_Comm comm=%s)", sendbuf, sendcnt, type_to_string(sendtype), recvbuf, recvcnt, type_to_string(recvtype), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Gatherv (void *sendbuf=%p, int sendcnt=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int *recvcnts=%p, int *displs=%p, MPI_Datatype recvtype=%s, int root=%d, MPI_Comm comm=%s)", sendbuf, sendcnt, type_to_string(sendtype), recvbuf, recvcnts, displs, type_to_string(recvtype), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Get_address (void *location=%p, MPI_Aint *address=%p)", location, address);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Get_count (MPI_Status *status=%p, MPI_Datatype datatype=%s, int *count=%p)", status, type_to_string(datatype), count);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Get_elements (MPI_Status *status=%p, MPI_Datatype datatype=%s, int *elements=%p)", status, type_to_string(datatype), elements);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Get_processor_name (char *name=%p, int *resultlen=%p)", name, resultlen);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Get_version (int *version=%p, int *subversion=%p)", version, subversion);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graph_create (MPI_Comm comm_old=%s, int nnodes=%d, int *indx=%p, int *edges=%p, int reorder=%d, MPI_Comm *comm_graph=%p)", comm_to_string(comm_old), nnodes, indx, edges, reorder, comm_graph);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graphdims_get (MPI_Comm comm=%s, int *nnodes=%p, int *nedges=%p)", comm_to_string(comm), nnodes, nedges);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graph_get (MPI_Comm comm=%s, int maxindex=%d, int maxedges=%d, int *indx=%p, int *edges=%p)", comm_to_string(comm), maxindex, maxedges, indx, edges);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graph_map (MPI_Comm comm_old=%s, int nnodes=%d, int *indx=%p, int *edges=%p, int *newrank=%p)", comm_to_string(comm_old), nnodes, indx, edges, newrank);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graph_neighbors_count (MPI_Comm comm=%s, int rank=%d, int *nneighbors=%p)", comm_to_string(comm), rank, nneighbors);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Graph_neighbors (MPI_Comm comm=%s, int rank=%d, int maxneighbors=%d, int *neighbors=%p)", comm_to_string(comm), rank, maxneighbors, neighbors);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Grequest_complete (MPI_Request request=%s)", request_to_string(request));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Grequest_start (MPI_Grequest_query_function *query_fn=%p, MPI_Grequest_free_function *free_fn=%p, MPI_Grequest_cancel_function *cancel_fn=%p, void *extra_state=%p, MPI_Request *request=%p)", query_fn, free_fn, cancel_fn, extra_state, request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_compare (MPI_Group group1=%s, MPI_Group group2=%s, int *result=%p)", group_to_string(group1), group_to_string(group2), result);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_difference (MPI_Group group1=%s, MPI_Group group2=%s, MPI_Group *newgroup=%p)", group_to_string(group1), group_to_string(group2), newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_excl (MPI_Group group=%s, int n=%d, int *ranks=%p, MPI_Group *newgroup=%p)", group_to_string(group), n, ranks, newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_free (MPI_Group *group=%p)", group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_incl (MPI_Group group=%s, int n=%d, int *ranks=%p, MPI_Group *newgroup=%p)", group_to_string(group), n, ranks, newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_intersection (MPI_Group group1=%s, MPI_Group group2=%s, MPI_Group *newgroup=%p)", group_to_string(group1), group_to_string(group2), newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_range_excl (MPI_Group group=%s, int n=%d, int ranges[][3]=%p, MPI_Group *newgroup=%p)", group_to_string(group), n, ranges, newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_range_incl (MPI_Group group=%s, int n=%d, int ranges[][3]=%p, MPI_Group *newgroup=%p)", group_to_string(group), n, ranges, newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_rank (MPI_Group group=%s, int *rank=%p)", group_to_string(group), rank);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_size (MPI_Group group=%s, int *size=%p)", group_to_string(group), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_translate_ranks (MPI_Group group1=%s, int n=%d, int *ranks1=%p, MPI_Group group2=%s, int *ranks2=%p)", group_to_string(group1), n, ranks1, group_to_string(group2), ranks2);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_union (MPI_Group group1=%s, MPI_Group group2=%s, MPI_Group *newgroup=%p)", group_to_string(group1), group_to_string(group2), newgroup);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Ibsend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_create (MPI_Info *info=%p)", info);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_delete (MPI_Info info=%s, char *key=%p)", info_to_string(info), key);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_dup (MPI_Info info=%s, MPI_Info *newinfo=%p)", info_to_string(info), newinfo);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_free (MPI_Info *info=%p)", info);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_get (MPI_Info info=%s, char *key=%p, int valuelen=%d, char *value=%p, int *flag=%p)", info_to_string(info), key, valuelen, value, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_get_nkeys (MPI_Info info=%s, int *nkeys=%p)", info_to_string(info), nkeys);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_get_nthkey (MPI_Info info=%s, int n=%d, char *key=%p)", info_to_string(info), n, key);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_get_valuelen (MPI_Info info=%s, char *key=%p, int *valuelen=%p, int *flag=%p)", info_to_string(info), key, valuelen, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_set (MPI_Info info=%s, char *key=%p, char *value=%p)", info_to_string(info), key, value);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Init (int *argc=%p, char ***argv=%p)", argc, argv);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Initialized (int *flag=%p)", flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Init_thread (int *argc=%p, char ***argv=%p, int required=%d, int *provided=%p)", argc, argv, required, provided);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Intercomm_create (MPI_Comm local_comm=%s, int local_leader=%d, MPI_Comm peer_comm=%s, int remote_leader=%d, int tag=%d, MPI_Comm *newintercomm=%p)", comm_to_string(local_comm), local_leader, comm_to_string(peer_comm), remote_leader, tag, newintercomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Intercomm_merge (MPI_Comm intercomm=%s, int high=%d, MPI_Comm *newintracomm=%p)", comm_to_string(intercomm), high, newintracomm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Iprobe (int source=%d, int tag=%d, MPI_Comm comm=%s, int *flag=%p, MPI_Status *status=%p)", source, tag, comm_to_string(comm), flag, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Irecv (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int source=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), source, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Irsend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Isend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Issend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Is_thread_main (int *flag=%p)", flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Keyval_create (MPI_Copy_function *copy_fn=%p, MPI_Delete_function *delete_fn=%p, int *keyval=%p, void *extra_state=%p)", copy_fn, delete_fn, keyval, extra_state);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Keyval_free (int *keyval=%p)", keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Lookup_name (char *service_name=%p, MPI_Info info=%s, char *port_name=%p)", service_name, info_to_string(info), port_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Op_create (MPI_User_function *function=%p, int commute=%d, MPI_Op *op=%p)", function, commute, op);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Open_port (MPI_Info info=%s, char *port_name=%p)", info_to_string(info), port_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Op_free (MPI_Op *op=%p)", op);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Pack_external (char *datarep=%p, void *inbuf=%p, int incount=%d, MPI_Datatype datatype=%s, void *outbuf=%p, MPI_Aint outcount=%p, MPI_Aint *position=%p)", datarep, inbuf, incount, type_to_string(datatype), outbuf, (void *) outcount, position);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Pack_external_size (char *datarep=%p, int incount=%d, MPI_Datatype datatype=%s, MPI_Aint *size=%p)", datarep, incount, type_to_string(datatype), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Pack (void *inbuf=%p, int incount=%d, MPI_Datatype datatype=%s, void *outbuf=%p, int outcount=%d, int *position=%p, MPI_Comm comm=%s)", inbuf, incount, type_to_string(datatype), outbuf, outcount, position, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Pack_size (int incount=%d, MPI_Datatype datatype=%s, MPI_Comm comm=%s, int *size=%p)", incount, type_to_string(datatype), comm_to_string(comm), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Pcontrol (const int=%p, level ...=%p)", (void *) int, (void *) ...);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Probe (int source=%d, int tag=%d, MPI_Comm comm=%s, MPI_Status *status=%p)", source, tag, comm_to_string(comm), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Publish_name (char *service_name=%p, MPI_Info info=%s, char *port_name=%p)", service_name, info_to_string(info), port_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Put (void *origin_addr=%p, int origin_count=%d, MPI_Datatype origin_datatype=%s, int target_rank=%d, MPI_Aint target_disp=%p, int target_count=%d, MPI_Datatype target_datatype=%s, MPI_Win win=%s)", origin_addr, origin_count, type_to_string(origin_datatype), target_rank, (void *) target_disp, target_count, type_to_string(target_datatype), win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Query_thread (int *provided=%p)", provided);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Recv (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int source=%d, int tag=%d, MPI_Comm comm=%s, MPI_Status *status=%p)", buf, count, type_to_string(datatype), source, tag, comm_to_string(comm), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Recv_init (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int source=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), source, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Reduce (void *sendbuf=%p, void *recvbuf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Op op=%s, int root=%d, MPI_Comm comm=%s)", sendbuf, recvbuf, count, type_to_string(datatype), op_to_string(op), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Reduce_scatter (void *sendbuf=%p, void *recvbuf=%p, int *recvcnts=%p, MPI_Datatype datatype=%s, MPI_Op op=%s, MPI_Comm comm=%s)", sendbuf, recvbuf, recvcnts, type_to_string(datatype), op_to_string(op), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Register_datarep (char *name=%p, MPI_Datarep_conversion_function *read_conv_fn=%p, MPI_Datarep_conversion_function *write_conv_fn=%p, MPI_Datarep_extent_function *extent_fn=%p, void *state=%p)", name, read_conv_fn, write_conv_fn, extent_fn, state);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Request_free (MPI_Request *request=%p)", request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Request_get_status (MPI_Request request=%s, int *flag=%p, MPI_Status *status=%p)", request_to_string(request), flag, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Rsend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Rsend_init (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Scan (void *sendbuf=%p, void *recvbuf=%p, int count=%d, MPI_Datatype datatype=%s, MPI_Op op=%s, MPI_Comm comm=%s)", sendbuf, recvbuf, count, type_to_string(datatype), op_to_string(op), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Scatter (void *sendbuf=%p, int sendcnt=%d, MPI_Datatype sendtype=%s, void *recvbuf=%p, int recvcnt=%d, MPI_Datatype recvtype=%s, int root=%d, MPI_Comm comm=%s)", sendbuf, sendcnt, type_to_string(sendtype), recvbuf, recvcnt, type_to_string(recvtype), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Scatterv (void *sendbuf=%p, int *sendcnts=%p, int *displs=%p, MPI_Datatype sendtype=%s, void *recvbuf=%p, int recvcnt=%d, MPI_Datatype recvtype=%s, int root=%d, MPI_Comm comm=%s)", sendbuf, sendcnts, displs, type_to_string(sendtype), recvbuf, recvcnt, type_to_string(recvtype), root, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Send (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Send_init (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Sendrecv (void *sendbuf=%p, int sendcount=%d, MPI_Datatype sendtype=%s, int dest=%d, int sendtag=%d, void *recvbuf=%p, int recvcount=%d, MPI_Datatype recvtype=%s, int source=%d, int recvtag=%d, MPI_Comm comm=%s, MPI_Status *status=%p)", sendbuf, sendcount, type_to_string(sendtype), dest, sendtag, recvbuf, recvcount, type_to_string(recvtype), source, recvtag, comm_to_string(comm), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Sendrecv_replace (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int sendtag=%d, int source=%d, int recvtag=%d, MPI_Comm comm=%s, MPI_Status *status=%p)", buf, count, type_to_string(datatype), dest, sendtag, source, recvtag, comm_to_string(comm), status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Ssend (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Ssend_init (void *buf=%p, int count=%d, MPI_Datatype datatype=%s, int dest=%d, int tag=%d, MPI_Comm comm=%s, MPI_Request *request=%p)", buf, count, type_to_string(datatype), dest, tag, comm_to_string(comm), request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Startall (int count=%d, MPI_Request array_of_requests[]=%p)", count, array_of_requests);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Start (MPI_Request *request=%p)", request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Status_set_cancelled (MPI_Status *status=%p, int flag=%d)", status, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Status_set_elements (MPI_Status *status=%p, MPI_Datatype datatype=%s, int count=%d)", status, type_to_string(datatype), count);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Testall (int count=%d, MPI_Request array_of_requests[]=%p, int *flag=%p, MPI_Status array_of_statuses[]=%p)", count, array_of_requests, flag, array_of_statuses);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Testany (int count=%d, MPI_Request array_of_requests[]=%p, int *index=%p, int *flag=%p, MPI_Status *status=%p)", count, array_of_requests, index, flag, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Test_cancelled (MPI_Status *status=%p, int *flag=%p)", status, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Test (MPI_Request *request=%p, int *flag=%p, MPI_Status *status=%p)", request, flag, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Testsome (int incount=%d, MPI_Request array_of_requests[]=%p, int *outcount=%p, int array_of_indices[]=%p, MPI_Status array_of_statuses[]=%p)", incount, array_of_requests, outcount, array_of_indices, array_of_statuses);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Topo_test (MPI_Comm comm=%s, int *topo_type=%p)", comm_to_string(comm), topo_type);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_commit (MPI_Datatype *datatype=%p)", datatype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_contiguous (int count=%d, MPI_Datatype old_type=%s, MPI_Datatype *new_type_p=%p)", count, type_to_string(old_type), new_type_p);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_darray (int size=%d, int rank=%d, int ndims=%d, int array_of_gsizes[]=%p, int array_of_distribs[]=%p, int array_of_dargs[]=%p, int array_of_psizes[]=%p, int order=%d, MPI_Datatype oldtype=%s, MPI_Datatype *newtype=%p)", size, rank, ndims, array_of_gsizes, array_of_distribs, array_of_dargs, array_of_psizes, order, type_to_string(oldtype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_f90_complex (int p=%d, int r=%d, MPI_Datatype *newtype=%p)", p, r, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_f90_integer (int r=%d, MPI_Datatype *newtype=%p)", r, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_f90_real (int p=%d, int r=%d, MPI_Datatype *newtype=%p)", p, r, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_hindexed (int count=%d, int blocklengths[]=%p, MPI_Aint displacements[]=%p, MPI_Datatype oldtype=%s, MPI_Datatype *newtype=%p)", count, blocklengths, displacements, type_to_string(oldtype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_hvector (int count=%d, int blocklength=%d, MPI_Aint stride=%p, MPI_Datatype oldtype=%s, MPI_Datatype *newtype=%p)", count, blocklength, (void *) stride, type_to_string(oldtype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_indexed_block (int count=%d, int blocklength=%d, int array_of_displacements[]=%p, MPI_Datatype oldtype=%s, MPI_Datatype *newtype=%p)", count, blocklength, array_of_displacements, type_to_string(oldtype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_keyval (MPI_Type_copy_attr_function *type_copy_attr_fn=%p, MPI_Type_delete_attr_function *type_delete_attr_fn=%p, int *type_keyval=%p, void *extra_state=%p)", type_copy_attr_fn, type_delete_attr_fn, type_keyval, extra_state);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_resized (MPI_Datatype oldtype=%s, MPI_Aint lb=%p, MPI_Aint extent=%p, MPI_Datatype *newtype=%p)", type_to_string(oldtype), (void *) lb, (void *) extent, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_struct (int count=%d, int array_of_blocklengths[]=%p, MPI_Aint array_of_displacements[]=%p, MPI_Datatype array_of_types[]=%p, MPI_Datatype *newtype=%p)", count, array_of_blocklengths, array_of_displacements, array_of_types, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_create_subarray (int ndims=%d, int array_of_sizes[]=%p, int array_of_subsizes[]=%p, int array_of_starts[]=%p, int order=%d, MPI_Datatype oldtype=%s, MPI_Datatype *newtype=%p)", ndims, array_of_sizes, array_of_subsizes, array_of_starts, order, type_to_string(oldtype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_delete_attr (MPI_Datatype type=%s, int type_keyval=%d)", type_to_string(type), type_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_dup (MPI_Datatype datatype=%s, MPI_Datatype *newtype=%p)", type_to_string(datatype), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_extent (MPI_Datatype datatype=%s, MPI_Aint *extent=%p)", type_to_string(datatype), extent);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_free (MPI_Datatype *datatype=%p)", datatype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_free_keyval (int *type_keyval=%p)", type_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_get_attr (MPI_Datatype type=%s, int type_keyval=%d, void *attribute_val=%p, int *flag=%p)", type_to_string(type), type_keyval, attribute_val, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_get_envelope (MPI_Datatype datatype=%s, int *num_integers=%p, int *num_addresses=%p, int *num_datatypes=%p, int *combiner=%p)", type_to_string(datatype), num_integers, num_addresses, num_datatypes, combiner);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_get_extent (MPI_Datatype datatype=%s, MPI_Aint *lb=%p, MPI_Aint *extent=%p)", type_to_string(datatype), lb, extent);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_get_name (MPI_Datatype datatype=%s, char *type_name=%p, int *resultlen=%p)", type_to_string(datatype), type_name, resultlen);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_get_true_extent (MPI_Datatype datatype=%s, MPI_Aint *true_lb=%p, MPI_Aint *true_extent=%p)", type_to_string(datatype), true_lb, true_extent);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_hindexed (int count=%d, int blocklens[]=%p, MPI_Aint indices[]=%p, MPI_Datatype old_type=%s, MPI_Datatype *newtype=%p)", count, blocklens, indices, type_to_string(old_type), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_hvector (int count=%d, int blocklen=%d, MPI_Aint stride=%p, MPI_Datatype old_type=%s, MPI_Datatype *newtype_p=%p)", count, blocklen, (void *) stride, type_to_string(old_type), newtype_p);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_indexed (int count=%d, int blocklens[]=%p, int indices[]=%p, MPI_Datatype old_type=%s, MPI_Datatype *newtype=%p)", count, blocklens, indices, type_to_string(old_type), newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_lb (MPI_Datatype datatype=%s, MPI_Aint *displacement=%p)", type_to_string(datatype), displacement);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_match_size (int typeclass=%d, int size=%d, MPI_Datatype *datatype=%p)", typeclass, size, datatype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_set_attr (MPI_Datatype type=%s, int type_keyval=%d, void *attribute_val=%p)", type_to_string(type), type_keyval, attribute_val);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_set_name (MPI_Datatype type=%s, char *type_name=%p)", type_to_string(type), type_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_size (MPI_Datatype datatype=%s, int *size=%p)", type_to_string(datatype), size);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_struct (int count=%d, int blocklens[]=%p, MPI_Aint indices[]=%p, MPI_Datatype old_types[]=%p, MPI_Datatype *newtype=%p)", count, blocklens, indices, old_types, newtype);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_ub (MPI_Datatype datatype=%s, MPI_Aint *displacement=%p)", type_to_string(datatype), displacement);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_vector (int count=%d, int blocklength=%d, int stride=%d, MPI_Datatype old_type=%s, MPI_Datatype *newtype_p=%p)", count, blocklength, stride, type_to_string(old_type), newtype_p);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Unpack_external (char *datarep=%p, void *inbuf=%p, MPI_Aint insize=%p, MPI_Aint *position=%p, void *outbuf=%p, int outcount=%d, MPI_Datatype datatype=%s)", datarep, inbuf, (void *) insize, position, outbuf, outcount, type_to_string(datatype));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Unpack (void *inbuf=%p, int insize=%d, int *position=%p, void *outbuf=%p, int outcount=%d, MPI_Datatype datatype=%s, MPI_Comm comm=%s)", inbuf, insize, position, outbuf, outcount, type_to_string(datatype), comm_to_string(comm));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Unpublish_name (char *service_name=%p, MPI_Info info=%s, char *port_name=%p)", service_name, info_to_string(info), port_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Waitall (int count=%d, MPI_Request array_of_requests[]=%p, MPI_Status array_of_statuses[]=%p)", count, array_of_requests, array_of_statuses);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Waitany (int count=%d, MPI_Request array_of_requests[]=%p, int *index=%p, MPI_Status *status=%p)", count, array_of_requests, index, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Wait (MPI_Request *request=%p, MPI_Status *status=%p)", request, status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Waitsome (int incount=%d, MPI_Request array_of_requests[]=%p, int *outcount=%p, int array_of_indices[]=%p, MPI_Status array_of_statuses[]=%p)", incount, array_of_requests, outcount, array_of_indices, array_of_statuses);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_call_errhandler (MPI_Win win=%s, int errorcode=%d)", win_to_string(win), errorcode);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_complete (MPI_Win win=%s)", win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_create_errhandler (MPI_Win_errhandler_fn *function=%p, MPI_Errhandler *errhandler=%p)", function, errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_create (void *base=%p, MPI_Aint size=%p, int disp_unit=%d, MPI_Info info=%s, MPI_Comm comm=%s, MPI_Win *win=%p)", base, (void *) size, disp_unit, info_to_string(info), comm_to_string(comm), win);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_create_keyval (MPI_Win_copy_attr_function *win_copy_attr_fn=%p, MPI_Win_delete_attr_function *win_delete_attr_fn=%p, int *win_keyval=%p, void *extra_state=%p)", win_copy_attr_fn, win_delete_attr_fn, win_keyval, extra_state);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_delete_attr (MPI_Win win=%s, int win_keyval=%d)", win_to_string(win), win_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_fence (int assert=%d, MPI_Win win=%s)", assert, win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_free (MPI_Win *win=%p)", win);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_free_keyval (int *win_keyval=%p)", win_keyval);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_get_attr (MPI_Win win=%s, int win_keyval=%d, void *attribute_val=%p, int *flag=%p)", win_to_string(win), win_keyval, attribute_val, flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_get_errhandler (MPI_Win win=%s, MPI_Errhandler *errhandler=%p)", win_to_string(win), errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_get_group (MPI_Win win=%s, MPI_Group *group=%p)", win_to_string(win), group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_get_name (MPI_Win win=%s, char *win_name=%p, int *resultlen=%p)", win_to_string(win), win_name, resultlen);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_lock (int lock_type=%d, int rank=%d, int assert=%d, MPI_Win win=%s)", lock_type, rank, assert, win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_post (MPI_Group group=%s, int assert=%d, MPI_Win win=%s)", group_to_string(group), assert, win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_set_attr (MPI_Win win=%s, int win_keyval=%d, void *attribute_val=%p)", win_to_string(win), win_keyval, attribute_val);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_set_errhandler (MPI_Win win=%s, MPI_Errhandler errhandler=%p)", win_to_string(win), (void *) errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_set_name (MPI_Win win=%s, char *win_name=%p)", win_to_string(win), win_name);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_start (MPI_Group group=%s, int assert=%d, MPI_Win win=%s)", group_to_string(group), assert, win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_test (MPI_Win win=%s, int *flag=%p)", win_to_string(win), flag);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_unlock (int rank=%d, MPI_Win win=%s)", rank, win_to_string(win));
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_wait (MPI_Win win=%s)", win_to_string(win));
   return MPI_ERR_INTERN;
...
double IMPI_Wtick ( )
{
   ...
   return PMPI_Wtick();
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Wtick ( )");
   return MPI_ERR_INTERN;
...
double IMPI_Wtime ( )
{
   ...
   return PMPI_Wtime();
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Wtime ( )");
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_f2c (MPI_Fint Comm=%d)", Comm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Comm_c2f (MPI_Comm Comm=%p)", (void *)Comm);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_f2c (MPI_Fint Group=%d)", Group);
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Group_c2f (MPI_Group Group=%p)", (void *)Group);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Request_f2c (MPI_Fint Request=%d)", Request);
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Request_c2f (MPI_Request Request=%p)", (void *)Request);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Status_f2c (MPI_Fint Status=%d)", Status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Status_c2f (MPI_Status Status=%p)", (void *)Status);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_f2c (MPI_Fint Info=%d)", Info);
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Info_c2f (MPI_Info Info=%p)", (void *)Info);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_f2c (MPI_Fint File=%d)", File);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_File_c2f (MPI_File File=%p)", (void *)File);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Op_f2c (MPI_Fint Op=%d)", Op);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Op_c2f (MPI_Op Op=%p)", (void *)Op);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_f2c (MPI_Fint Win=%d)", Win);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Win_c2f (MPI_Win Win=%p)", (void *)Win);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_f2c (MPI_Fint Errhandler=%d)", Errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Errhandler_c2f (MPI_Errhandler Errhandler=%p)", (void *)Errhandler);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_f2c (MPI_Fint Type=%d)", Type);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_Type_c2f (MPI_Type Type=%p)", (void *)Type);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_XXX_f2c (MPI_Fint XXX=%d)", XXX);
   return MPI_ERR_INTERN;
...
#else
   IERROR(1, "NOT IMPLEMENTED: MPI_XXX_c2f (MPI_XXX XXX=%p)", (void *)XXX);
   return MPI_ERR_INTERN;
