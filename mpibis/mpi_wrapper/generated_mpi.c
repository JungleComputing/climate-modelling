...
{
#ifdef TRACE_CALLS
   INFO(0, "MPI_Status_f2c", "(status=%d)", Status);
#endif // TRACE_CALLS
...
{
#ifdef TRACE_CALLS
   INFO(0, "MPI_Status_c2f", "(status=%p)", (void *)Status);
#endif // TRACE_CALLS
...
/*
MPI_XXX MPI_XXX_f2c(MPI_Fint XXX)
{
#ifdef TRACE_CALLS
   INFO(0, "MPI_XXX_f2c", "(XXX=%d)", XXX);
#endif // TRACE_CALLS

#ifdef IBIS_INTERCEPT
   return IMPI_XXX_f2c(XXX);
#else
...
MPI_Fint MPI_XXX_c2f(MPI_XXX XXX)
{
#ifdef TRACE_CALLS
   INFO(0, "MPI_XXX_c2f", "(XXX=%p)", (void *)XXX);
#endif // TRACE_CALLS

#ifdef IBIS_INTERCEPT
   return IMPI_XXX_c2f(XXX);
#else
