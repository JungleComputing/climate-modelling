...
!
    ...
    if ( history_budget ) then
       ...
       call add_default(hadvnam(       1), 1, ' ')
       call add_default(hadvnam(ixcldliq), 1, ' ')
       call add_default(hadvnam(ixcldice), 1, ' ')
       call add_default(vadvnam(       1), 1, ' ')
       call add_default(vadvnam(ixcldliq), 1, ' ')
       call add_default(vadvnam(ixcldice), 1, ' ')
       call add_default(fixcnam(       1), 1, ' ')
       call add_default(fixcnam(ixcldliq), 1, ' ')
       call add_default(fixcnam(ixcldice), 1, ' ')
       call add_default(tottnam(       1), 1, ' ')
       call add_default(tottnam(ixcldliq), 1, ' ')
       call add_default(tottnam(ixcldice), 1, ' ')
       call add_default(tendnam(       1), 1, ' ')
       call add_default(tendnam(ixcldliq), 1, ' ')
       call add_default(tendnam(ixcldice), 1, ' ')
       call add_default('TTEND   '       , 1, ' ')
       call add_default('TFIX    '       , 1, ' ')
       call add_default('KTOOP   '       , 1, ' ')
       call add_default('VAT     '       , 1, ' ')
    end if
