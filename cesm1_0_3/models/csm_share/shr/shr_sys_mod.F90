...
!  JASON: fix for gfortran: if system is declared external, it doesn't use the intrinsic function anymore, so added __GFORTRAN__ 
!
#if (defined OSF1 || defined SUNOS || (defined LINUX && !defined __G95__ && !defined CATAMOUNT && !defined __GFORTRAN__))
...
! JASON: added __GFORTRAN__
!
#if (defined OSF1 || defined SUNOS || defined LINUX && !defined CATAMOUNT || defined __G95__ || defined __GFORTRAN__)
   rcode = system(str)
#endif

! JASON: added __GFORTRAN__
!
#if (!defined CRAY && !defined IRIX64 && !defined AIX && !defined OSF1 && !defined SUNOS && !defined LINUX && !defined NEC_SX && !defined UNICOSMP && !defined __G95__ && !defined __GFORTRAN__)
...
! JASON: Added __GFORTRAN__
!
#if (defined AIX || defined OSF1 || defined SUNOS || (defined LINUX && !defined __G95__ && !defined __GFORTRAN__) || defined NEC_SX)
...
! JASON: added __GFORTRAN__
!
#if (defined OSF1 || defined SUNOS || defined LINUX || defined NEC_SX || defined __G95__ || defined __GFORTRAN__)
...
! JASON: Added __GFORTRAN__
!
#if (defined AIX || defined OSF1 || defined SUNOS || defined LINUX || defined NEC_SX || defined __G95__ || defined __GFORTRAN__)
...
! JASON: Added __GFORTRAN__
!
#if (defined IRIX64 || defined CRAY || defined OSF1 || defined SUNOS || defined LINUX || defined NEC_SX || defined UNICOSMP || defined __G95__ || defined __GFORTRAN__)
   call flush(unit)
#endif
#if (defined AIX)
   call flush_(unit)
