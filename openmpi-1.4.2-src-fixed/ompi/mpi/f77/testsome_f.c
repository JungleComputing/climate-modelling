...
// JM:FIXED                 array_of_requests[OMPI_INT_2_FINT(array_of_indices[i])] =
// JM:FIXED                     c_req[OMPI_INT_2_FINT(array_of_indices[i])]->req_f_to_c_index;
                array_of_requests[OMPI_INT_2_FINT(array_of_indices[i])] =
                    MPI_Request_c2f(c_req[OMPI_INT_2_FINT(array_of_indices[i])]);
