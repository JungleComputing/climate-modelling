...
!::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
  ...
  if(SendRout%nprocs > 0) then
	...
	! allocate buffer to hold all outgoing integer data
        ISendSize = 1
...
#ifdef JASON_WRITE
    write(*,*) 'JASON: isendbuf: ', ISendSize
#endif
	...
	! allocate buffer to hold all outgoing real data
        RSendSize = 1
	do proc=1,SendRout%nprocs
...
#ifdef JASON_WRITE
	write(*,*) 'JASON: rsendbuf: ', RSendSize
#endif
  ...
  if(RecvRout%nprocs > 0) then
	...
	! allocate buffer to hold all incoming integer data
        IRecvSize = 1
	...
	! allocate buffer to hold all incoming real data
        RRecvSize = 1
	do proc=1,RecvRout%nprocs
...
#ifdef JASON_WRITE
write(*,*) 'JASON: int ircv ', ThisMCTWorld%MCT_comm, max_pe, myPid, &
            RecvRout%pe_list(proc), RecvRout%locsize(proc)*numi
#endif
...
#ifdef JASON_WRITE
write(*,*) 'JASON: real ircv ', ThisMCTWorld%MCT_comm, max_pe, myPid, &
            RecvRout%pe_list(proc), RecvRout%locsize(proc)*numr
#endif
...
#ifdef JASON_WRITE
write(*,*) 'JASON: int isnd ', ThisMCTWorld%MCT_comm, max_pe, myPid, &
            SendRout%pe_list(proc), SendRout%locsize(proc)*numi
#endif
...
#ifdef JASON_WRITE
write(*,*) 'JASON: real isnd ', ThisMCTWorld%MCT_comm, max_pe, myPid, &
            SendRout%pe_list(proc), SendRout%locsize(proc)*numr
#endif
...
#ifdef JASON_WRITE
write(*,*) 'JASON: int a2a ', ThisMCTWorld%MCT_comm, max_pe, myPid
#endif
