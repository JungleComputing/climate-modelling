...
#undef DEBUG
  ...
  ! Register history variables
    ...
    do m = 1, ncnst
       ...
       call addfld( cnst_name(mm), 'kg/kg   ', pver, avg_flag, cnst_longname(mm), phys_decomp )
    ...
    call addfld (apcnst(m), 'kg/kg   ', pver, avg_flag, trim(cnst_name(m))//' after physics'  , phys_decomp)
    call addfld (bpcnst(m), 'kg/kg   ', pver, avg_flag, trim(cnst_name(m))//' before physics' , phys_decomp)
    if( history_budget) call add_default (apcnst(m), 1, ' ')
    if( history_budget) call add_default (bpcnst(m), 1, ' ')
  ...
  ! History variables for CAM5 macro-microphysics
    ...
    if ( history_budget ) then
       ...
       if( cam_physpkg_is('cam3') .or. cam_physpkg_is('cam4') ) then
          ...
          call add_default ('CMEICE   ', 1, ' ')
          call add_default ('LIQ2PR   ', 1, ' ')
          call add_default ('ICE2PR   ', 1, ' ')
          call add_default ('HCME     ', 1, ' ')
          call add_default ('HEVAP    ', 1, ' ')
          call add_default ('HFREEZ   ', 1, ' ')
          call add_default ('HMELT    ', 1, ' ')
          call add_default ('HREPART  ', 1, ' ')
          call add_default ('HPROGCLD ', 1, ' ')
          call add_default ('REPARTLIQ', 1, ' ')
          call add_default ('REPARTICE', 1, ' ')

       elseif( cam_physpkg_is('cam5') ) then

          call add_default ('QVRES    ', 1, ' ')
          call add_default ('QISEVAP  ', 1, ' ')
          call add_default ('QCSEVAP  ', 1, ' ')
          call add_default ('QISEDTEN ', 1, ' ')
          call add_default ('QCSEDTEN ', 1, ' ')
          call add_default ('QIRESO   ', 1, ' ')
          call add_default ('QCRESO   ', 1, ' ')
          call add_default ('PSACWSO  ', 1, ' ')
          call add_default ('PRCO     ', 1, ' ')
          call add_default ('PRCIO    ', 1, ' ')
          call add_default ('PRAO     ', 1, ' ')
          call add_default ('PRAIO    ', 1, ' ')
          call add_default ('PRACSO   ', 1, ' ')
          call add_default ('MSACWIO  ', 1, ' ')
          call add_default ('MPDW2V   ', 1, ' ')
          call add_default ('MPDW2P   ', 1, ' ')
          call add_default ('MPDW2I   ', 1, ' ')
          call add_default ('MPDT     ', 1, ' ')
          call add_default ('MPDQ     ', 1, ' ')
          call add_default ('MPDLIQ   ', 1, ' ')
          call add_default ('MPDICE   ', 1, ' ')
          call add_default ('MPDI2W   ', 1, ' ')
          call add_default ('MPDI2V   ', 1, ' ')
          call add_default ('MPDI2P   ', 1, ' ')
          call add_default ('MNUCCTO  ', 1, ' ')
          call add_default ('MNUCCRO  ', 1, ' ')
          call add_default ('MNUCCCO  ', 1, ' ')
          call add_default ('MELTSDT  ', 1, ' ')
          call add_default ('MELTO    ', 1, ' ')
          call add_default ('MACPDT   ', 1, ' ')
          call add_default ('MACPDQ   ', 1, ' ')
          call add_default ('MACPDLIQ ', 1, ' ')
          call add_default ('MACPDICE ', 1, ' ')
          call add_default ('HOMOO    ', 1, ' ')
          call add_default ('FRZRDT   ', 1, ' ')
          call add_default ('CMEIOUT  ', 1, ' ')
          call add_default ('CLDVAPADJ', 1, ' ')
          call add_default ('CLDLIQLIM', 1, ' ')
          call add_default ('CLDLIQDET', 1, ' ')
          call add_default ('CLDLIQADJ', 1, ' ')
          call add_default ('CLDICELIM', 1, ' ')
          call add_default ('CLDICEDET', 1, ' ')
          call add_default ('CLDICEADJ', 1, ' ')
          call add_default ('BERGSO   ', 1, ' ')
          call add_default ('BERGO    ', 1, ' ')
          call add_default ('DPDLFLIQ ', 1, ' ')
          call add_default ('DPDLFICE ', 1, ' ')
          call add_default ('SHDLFLIQ ', 1, ' ')
          call add_default ('SHDLFICE ', 1, ' ')
          call add_default ('DPDLFT   ', 1, ' ')
          call add_default ('SHDLFT   ', 1, ' ')
