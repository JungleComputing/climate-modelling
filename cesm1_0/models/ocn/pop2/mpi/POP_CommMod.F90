...
!-----------------------------------------------------------------------
   ...
   write(*,*) 'JASON: MPI_COMM_GROUP ', POP_Communicator ,MPI_GROUP_OCN
...
!-----------------------------------------------------------------------
   ...
   write(*,*) 'JASON: MPI_GROUP_RANGE_INCL ', MPI_GROUP_OCN, MPI_GROUP_NEW

   call MPI_COMM_CREATE (POP_Communicator, MPI_GROUP_NEW,  &
                         newCommunicator, ierr)

   write(*,*) 'JASON: MPI_COMM_CREATE ', POP_Communicator, MPI_GROUP_NEW
