...
80 format(i2.2,':',i2.2,':',i2.2)
  ...
  subroutine seq_io_write_av(filename,cdata,AV,dname,whead,wdata,nx,ny,nt,fillval,pre,tavg,&
	                     use_float)
    ...
    call seq_cdata_setptrs(cdata,gsmap=gsmap)
    call seq_comm_setptrs(CPLID,iam=iam)	
...
!===============================================================================
  ...
  subroutine seq_io_read_int(filename,cdata,idata,dname)
    ...
    call seq_io_read_int1d(filename,cdata,i1d,dname)
    idata = i1d(1)
  ...
  subroutine seq_io_read_r8(filename,cdata,rdata,dname)
    ...
    call seq_io_read_r81d(filename,cdata,r1d,dname)
    rdata = r1d(1)
