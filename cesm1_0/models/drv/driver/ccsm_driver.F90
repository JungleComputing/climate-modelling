...
!-------------------------------------------------------------------------------
   ...
   if (iamroot_CPLID) then
      write(*,*) 'JASON: mpicom_GLOID: ', mpicom_GLOID
      write(*,*) 'JASON: mpicom_CPLID: ', mpicom_CPLID
      write(*,*) 'JASON: mpicom_ATMID: ', mpicom_ATMID
      write(*,*) 'JASON: mpicom_LNDID: ', mpicom_LNDID
      write(*,*) 'JASON: mpicom_ICEID: ', mpicom_ICEID
      write(*,*) 'JASON: mpicom_OCNID: ', mpicom_OCNID
      write(*,*) 'JASON: mpicom_GLCID: ', mpicom_GLCID
      write(*,*) 'JASON: mpicom_CPLATMID: ', mpicom_CPLATMID
      write(*,*) 'JASON: mpicom_CPLLNDID: ', mpicom_CPLLNDID
      write(*,*) 'JASON: mpicom_CPLICEID: ', mpicom_CPLICEID
      write(*,*) 'JASON: mpicom_CPLOCNID: ', mpicom_CPLOCNID
      write(*,*) 'JASON: mpicom_CPLGLCID: ', mpicom_CPLGLCID
   endif
...
! JASON
#ifdef JASON_WRITE    
      write(*,*) 'JASON: atm import:', nIAttr(x2a_aa), nRAttr(x2a_aa), lsize(x2a_aa)
      write(*,*) 'JASON: atm export:', nIAttr(a2x_aa), nRAttr(a2x_aa), lsize(a2x_aa)
#endif 
...
! JASON
#ifdef JASON_WRITE    
      write(*,*) 'JASON: lnd import:', nIAttr(x2l_ll), nRAttr(x2l_ll), lsize(x2l_ll)
      write(*,*) 'JASON: lnd export:', nIAttr(l2x_ll), nRAttr(l2x_ll), lsize(l2x_ll)
      write(*,*) 'JASON: rof export:', nIAttr(r2x_rr), nRAttr(r2x_rr), lsize(r2x_rr)
      write(*,*) 'JASON: sno import:', nIAttr(x2s_ss), nRAttr(x2s_ss), lsize(x2s_ss)
      write(*,*) 'JASON: sno export:', nIAttr(s2x_ss), nRAttr(s2x_ss), lsize(s2x_ss)
#endif 
...
! JASON
#ifdef JASON_WRITE        
      write(*,*) 'JASON: ocn import:', nIAttr(x2o_oo), nRAttr(x2o_oo), lsize(x2o_oo)
      write(*,*) 'JASON: ocn export:', nIAttr(o2x_oo), nRAttr(o2x_oo), lsize(o2x_oo)
#endif
...
! JASON
#ifdef JASON_WRITE    
      write(*,*) 'JASON: ice import:', nIAttr(x2i_ii), nRAttr(x2i_ii), lsize(x2i_ii)
      write(*,*) 'JASON: ice export:', nIAttr(i2x_ii), nRAttr(i2x_ii), lsize(i2x_ii)
#endif
...
! JASON
#ifdef JASON_WRITE    
      write(*,*) 'JASON: glc import:', nIAttr(x2g_gg), nRAttr(x2g_gg), lsize(x2g_gg)
      write(*,*) 'JASON: glc export:', nIAttr(g2x_gg), nRAttr(g2x_gg), lsize(g2x_gg)
#endif
...
! JASON
#ifdef JASON_WRITE    
      write(*,*) 'JASON: atm-ocn flux:', nIAttr(xao_ox), nRAttr(xao_ox), lsize(xao_ox)
#endif
   ...
   write(*,*) 'JASON initialization completed', (mpi_wtime() - Time_begin) 

   do while ( .not. stop_alarm)

      write(*,*) 'JASON main loop start', (mpi_wtime() - Time_begin)
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_atm2ocn_mct', (iamin_CPLID .and. (ice_present.or.ocn_present)), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_rof2ocn_mct', (ocn_present .and. ocnrun_alarm .and. iamin_CPLID &
              .and. ocn_prognostic .and. rof_present .and. ocnrof_prognostic), (mpi_wtime() - Time_begin)
  write(*,*) 'JASON map_ocnx2ocno_mct', (ocn_present .and. ocnrun_alarm .and. iamin_CPLOCNID &
              .and. ocn_prognostic), (mpi_wtime() - Time_begin)
#endif 
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_atm2lnd_mct', (lnd_present .and. lndrun_alarm .and. iamin_CPLID .and. &
   lnd_prognostic), (mpi_wtime() - Time_begin)

  write(*,*) 'JASON map_lndx2lndl_mct', (lnd_present .and. lndrun_alarm .and. iamin_CPLLNDID & 
   .and. lnd_prognostic), (mpi_wtime() - Time_begin)

  write(*,*) 'JASON map_snox2snos_mct', (lnd_present .and. lndrun_alarm .and. iamin_CPLLNDID &
   .and. glc_present .and. sno_prognostic), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_ocn2ice_mct', (ice_present .and. icerun_alarm .and. iamin_CPLID &
    .and. ice_prognostic), (mpi_wtime() - Time_begin)

  write(*,*) 'JASON map_icex2icei_mct', (ice_present .and. icerun_alarm .and. iamin_CPLICEID &
    .and. ice_prognostic), (mpi_wtime() - Time_begin)
#endif 
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON ocn_run_mct', (ocn_present .and. ocnrun_alarm .and. iamin_OCNID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON icn_run_mct', (ice_present .and. icerun_alarm .and. iamin_ICEID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON lnd_run_mct', ((lnd_present.or.rof_present.or.sno_present) .and. & 
   lndrun_alarm .and. iamin_LNDID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_ocno2ocnx_mct', (ocean_tight_coupling .and. ocn_present .and. &
   ocnnext_alarm .and. iamin_CPLOCNID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_ice2ocn_mct', (ocn_present .and. iamin_CPLID .and. ocn_prognostic &
     .and. ice_present), (mpi_wtime() - Time_begin)
  write(*,*) 'JASON map_atm2ocn_mct', (ocn_present .and. iamin_CPLID .and. ocn_prognostic &
     .and. (trim(aoflux_grid) == 'atm')), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_lndl2lndx_mct', (lnd_present .and. lndrun_alarm .and. iamin_CPLLNDID), (mpi_wtime() - Time_begin)
  write(*,*) 'JASON map_rofr2rofx_mct', (rof_present .and. lndrun_alarm .and. iamin_CPLLNDID), (mpi_wtime() - Time_begin)
  write(*,*) 'JASON map_snos2snox_mct', (sno_present .and. lndrun_alarm .and. iamin_CPLLNDID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_sno2glc_mct', (sno_present .and. glcrun_alarm .and. iamin_CPLID .and. glc_prognostic), (mpi_wtime() - Time_begin)
  write(*,*) 'JASON map_glcx2glcg_mct', (sno_present .and. glcrun_alarm .and. iamin_CPLGLCID .and. glc_prognostic), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
  write(*,*) 'JASON map_icei2icex_mct', (ice_present .and. icerun_alarm .and. iamin_CPLICEID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
write(*,*) 'JASON map_ocn2atm_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLID .and. &
                                  (atm_prognostic .or. trim(aoflux_grid) == 'atm')), (mpi_wtime() - Time_begin)

write(*,*) 'JASON map_ocn2atm_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLID .and. atm_prognostic & 
                                        .and. ocn_present .and. (trim(aoflux_grid) == 'ocn')), (mpi_wtime() - Time_begin)

write(*,*) 'JASON map_ice2atm_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLID .and. atm_prognostic & 
                                        .and. ice_present), (mpi_wtime() - Time_begin) 

write(*,*) 'JASON map_lnd2atm_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLID .and. atm_prognostic &
                                        .and. lnd_present), (mpi_wtime() - Time_begin) 

write(*,*) 'JASON map_atmx2atma_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLATMID .and. & 
                                         atm_prognostic), (mpi_wtime() - Time_begin)
#endif
      ...
      !----------------------------------------------------------
#ifdef JASON_WRITE    
   write(*,*) 'JASON atm_run_mct', (atm_present .and. atmrun_alarm .and. iamin_ATMID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
   write(*,*) 'JASON glc_run_mct', (glc_present .and. glcrun_alarm .and. iamin_GLCID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
   write(*,*) 'JASON map_glcg2glcx_mct', (glc_present .and. sno_prognostic .and. glcrun_alarm &
       .and. iamin_CPLGLCID), (mpi_wtime() - Time_begin) 
   write(*,*) 'JASON map_glc2sno_mct', (glc_present .and. sno_prognostic .and. glcrun_alarm &
       .and. iamin_CPLID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
   write(*,*) 'JASON map_atma2atmx_mct', (atm_present .and. atmrun_alarm .and. iamin_CPLATMID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
   write(*,*) 'JASON map_ocno2ocnx_mct', ((.not.ocean_tight_coupling) .and. ocn_present .and. & 
      ocnnext_alarm .and. iamin_CPLOCNID), (mpi_wtime() - Time_begin)
#endif
...
#ifdef JASON_WRITE    
   write(*,*) 'JASON main loop end', (mpi_wtime() - Time_begin) 
#endif
